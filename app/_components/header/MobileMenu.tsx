...
export default function MobileMenu({
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="grid  z-10 items-center grid-cols-2 md:hidden px-6 py-5 fixed top-12 rounded-2xl bg-linear-to-r from-[#d9d9d91f]  max-w-[90%] w-full to-[#7373731f] mt-12 md:mt-16 std-backdrop-blur"
    >
      <ul
